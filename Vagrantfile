...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # Provision the VM using the shell provider and a couple of scripts that
  # do all of the heavy lifting.
  config.vm.provision :shell, path: "apt_packages.sh"
  config.vm.provision :shell, path: "shadowcraft-setup.sh"
